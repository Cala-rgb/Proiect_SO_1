...
void update_log_file(char hunt[], char op[], char tid[], int failed) {
    ...
    snprintf(path, sizeof(path), LOG_PATH_FORMAT, hunt);
...
void create_treasure(char *hunt) {
    ...
    static char path[PATH_SIZE];
    snprintf(path, sizeof(path), TREASURE_PATH_FORMAT, hunt);
...
void view_treasure(char hunt_id[], char treasure_id[]) {
    static char path[PATH_SIZE];
    snprintf(path, sizeof(path), TREASURE_PATH_FORMAT, hunt_id);
...
void delete_hunt(char hunt_id[]) {
    ...
    snprintf(hunt_dir, sizeof(hunt_dir), HUNT_PATH_FORMAT, hunt_id);
    snprintf(path, sizeof(path), TREASURE_PATH_FORMAT, hunt_id);
    ...
    snprintf(path, sizeof(path), LOG_PATH_FORMAT, hunt_id);
    snprintf(path2, sizeof(path2), ROOT_LOG_PATH_FORMAT, hunt_id);
...
int create_bin_file(char dir[]) {
    static char path[PATH_SIZE];
    snprintf(path, sizeof(path), TREASURE_PATH_FORMAT, dir);
...
int create_log_file(char dir[]) {
    static char path[PATH_SIZE], link_path[PATH_SIZE];
    snprintf(path, sizeof(path), LOG_PATH_FORMAT, dir);
    snprintf(link_path, sizeof(link_path), ROOT_LOG_PATH_FORMAT, dir);
    ...
    // Create relative path for symlink target
    char relative_path[PATH_SIZE];
    snprintf(relative_path, sizeof(relative_path), "%s/%s", dir, LOG_FILE);
