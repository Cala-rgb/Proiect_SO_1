...
void delete_hunt(char hunt_id[]) {
    ...
    snprintf(hunt_dir, sizeof(hunt_dir), "hunts/%s", hunt_id);
    snprintf(path, sizeof(path), "%s/treasure.bin", hunt_dir);
    ...
    snprintf(path, sizeof(path), "%s/logged_hunt.txt", hunt_dir);
    snprintf(path2, sizeof(path2), "hunts/logged_hunt_%s", hunt_id);
...
int create_log_file(char dir[]) {
    ...
    snprintf(path, sizeof(path), "hunts/%s/logged_hunt.txt", dir);
    snprintf(link_path, sizeof(link_path), "hunts/logged_hunt_%s", dir);
    // Create relative path for the symlink target
    snprintf(relative_path, sizeof(relative_path), "%s/logged_hunt.txt", dir);
